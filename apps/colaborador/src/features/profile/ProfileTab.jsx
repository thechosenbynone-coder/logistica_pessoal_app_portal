    ...
    return (
        <div className="space-y-4 pb-4">
            ...
            <div className="bg-white rounded-xl p-5 shadow-md">
                ...
                <button
                    onClick={onLogout}
                    className="mt-3 w-full inline-flex items-center justify-center gap-2 rounded-lg bg-slate-100 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-200"
                >
